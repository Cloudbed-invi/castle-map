...
export function MapGrid({ cellColors, activeColor, onCellPointerDown, onCellPointerEnter, zigzagColor, lines, setLines, floatingTexts, setFloatingTexts, mapTitle, mapSubtitle }) {
  const SIZE = 24; 
        ...
        <g>
          ...
          {floatingTexts?.map(t => (
            <text 
              ...
              textAnchor="middle" 
              fontSize={t.size || 48} 
              transform={`rotate(${t.rotate || 0}, ${t.x}, ${t.y})`}
              fontWeight="bold" 
              fill="#0f172a"
              stroke="#ffffff"
              strokeWidth="6"
